...
##### SETUP #####
## Paths ##
var dialogues_folder = 'res://Scripts/Dialogue/' # Folder where the JSON files will be stored
var choice_scene = load('res://Scenes/Menus/Choice.tscn') # Base scene for que choices
## Required nodes ##
...
onready var progress = Global # The AutoLoad script where the interaction log, quest variables, inventory and other useful data should be acessible.
